 ...
 * @author ASUS
 */
public class pertemuan_3_2 extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public pertemuan_3_2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(txtkeluaran);
        ...
        cbhuruf.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Arial", "Vardana", "Tahoma" }));
        ...
        cbwarna.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "merah", "hijaw", "biru" }));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(cbhuruf, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void cbhurufActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbhurufActionPerformed
        ...
        txtkeluaran.setFont(new Font(cbhuruf.getSelectedItem().toString(),Font.PLAIN,
    ...
    private void cbwarnaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbwarnaActionPerformed
        ...
        else if(cbwarna.getSelectedItem()=="Hijaw")
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pertemuan_3_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pertemuan_3_2().setVisible(true);
            }
        });
    }
